...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Family-owned optical store in Chennai since 1986. Honest opinions, modern tech." },
    ],
  }),
  component: About,
});
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <p className="mt-6 text-lg text-muted-foreground">
          ...
          eye-test chair and a glass cabinet of frames. Three generations later, we still
          believe an eye exam should take time and a frame should fit your face — not the
          other way around.
        </p>
        <p className="mt-4 text-lg text-muted-foreground">
          What's new is the technology in the room. Our in-browser face-measurement uses Google's
          MediaPipe FaceMesh to estimate your face width and pupillary distance from a webcam —
          the same approach used by Lenskart and Warby Parker — so you can find a frame that fits
          before you walk in.
        </p>
